...
#pragma once
#if ! defined (hiir_Upsampler2xF64Neon_HEADER_INCLUDED)
#define hiir_Upsampler2xF64Neon_HEADER_INCLUDED
...
public:
	...
	static constexpr double _delay = 0;
	               ...
	               Upsampler2xF64Neon () noexcept;
	               Upsampler2xF64Neon (const Upsampler2xF64Neon <NC> &other) = default;
	               Upsampler2xF64Neon (Upsampler2xF64Neon <NC> &&other) = default;
	               ~Upsampler2xF64Neon ()                            = default;

	Upsampler2xF64Neon &
	               operator = (const Upsampler2xF64Neon <NC> &other) = default;
	Upsampler2xF64Neon &
	               operator = (Upsampler2xF64Neon <NC> &&other)      = default;
...
private:
	...
	bool           operator == (const Upsampler2xF64Neon <NC> &other) const = delete;
	bool           operator != (const Upsampler2xF64Neon <NC> &other) const = delete;
...
#include "hiir/Upsampler2xF64Neon.hpp"



#endif // hiir_Upsampler2xF64Neon_HEADER_INCLUDED
