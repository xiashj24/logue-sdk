...
CpuId::CpuId ()
{
	...
	_mmx_flag     = ((edx & (1UL << 23)) != 0);
	_sse_flag     = ((edx & (1UL << 25)) != 0);
	_sse2_flag    = ((edx & (1UL << 26)) != 0);
	_sse3_flag    = ((ecx & (1UL <<  0)) != 0);
	_ssse3_flag   = ((ecx & (1UL <<  9)) != 0);
	_cx16_flag    = ((ecx & (1UL << 13)) != 0);
	_fma3_flag    = ((ecx & (1UL << 16)) != 0);
	_sse41_flag   = ((ecx & (1UL << 19)) != 0);
	_sse42_flag   = ((ecx & (1UL << 20)) != 0);
	_abm_flag     = ((ecx & (1UL << 23)) != 0);
	_avx_flag     = ((ecx & (1UL << 28)) != 0);
	_f16c_flag    = ((ecx & (1UL << 29)) != 0);

	if (hf_basic >= 0x00000007)
	{
		// Extended Features
		call_cpuid (0x00000007, 0, eax, ebx, ecx, edx);
		_bmi1_flag    = ((ebx & (1UL <<  3)) != 0);
		_avx2_flag    = ((ebx & (1UL <<  5)) != 0);
		_bmi2_flag    = ((ebx & (1UL <<  8)) != 0);
		_avx512f_flag = ((ebx & (1UL << 16)) != 0);
	}
	...
	if (hf_ext >= 0x80000001)
	{
		...
		_isse_flag    = ((edx & (1UL << 22)) != 0) || _sse_flag;
		_sse4a_flag   = ((ecx & (1UL <<  6)) != 0);
		_fma4_flag    = ((ecx & (1UL << 16)) != 0);
		_3dnow_flag   = ((ecx & (1UL << 31)) != 0);
	}
