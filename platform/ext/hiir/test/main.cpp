...
#if defined (_MSC_VER)
static int __cdecl	HIIR_new_handler_cb ([[maybe_unused]] size_t dummy)
{
	throw std::bad_alloc ();
//	return (0);
}
...
static int	__cdecl	HIIR_debug_alloc_hook_cb (
	[[maybe_unused]] int alloc_type,
	[[maybe_unused]] void *user_data_ptr,
	[[maybe_unused]] size_t size,
	[[maybe_unused]] int block_type,
	[[maybe_unused]] long request_nbr,
	[[maybe_unused]] const unsigned char *filename_0,
	[[maybe_unused]] int line_nbr
)
{
	// Ignore CRT blocks to prevent infinite recursion
...
#if defined (_MSC_VER) && ! defined (NDEBUG)
static int	__cdecl	HIIR_debug_report_hook_cb (
	[[maybe_unused]] int report_type,
	[[maybe_unused]] char *user_msg_0,
	[[maybe_unused]] int *ret_val_ptr
)
{
