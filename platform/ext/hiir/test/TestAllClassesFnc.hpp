...
int	TestAllClassesFnc <NC>::perform_test (double transition_bw)
{
	...
	if (ret_val == 0 && cpu._neon_flag)
	{
		// hiir::HalfBandF64Neon
		typedef HalfBandF64Neon <NBR_COEFS> TestedType;
		AlignedObject <TestedType> container;
		TestedType &   dspl = container.use ();
		ret_val = TestHalfBand <TestedType>::perform_test (
			dspl, coef_arr, ss, "neon", transition_bw, stopband_at
	...
	if (ret_val == 0 && cpu._neon_flag)
	{
		// hiir::HalfBand2F64Neon
		typedef HalfBand2F64Neon <NBR_COEFS> TestedType;
		AlignedObject <TestedType> container;
		TestedType &   dspl = container.use ();
		ret_val = TestHalfBand <TestedType>::perform_test (
			dspl, coef_arr, ss, "neon", transition_bw, stopband_at
	...
	if (ret_val == 0 && cpu._neon_flag)
	{
		// hiir::Downsampler2xF64Neon
		typedef Downsampler2xF64Neon <NBR_COEFS> TestedType;
		AlignedObject <TestedType> container;
		TestedType &   dspl = container.use ();
		ret_val = TestDownsampler2x <TestedType>::perform_test (
			dspl, coef_arr, ss, "neon", transition_bw, stopband_at
	...
	if (ret_val == 0 && cpu._neon_flag)
	{
		// hiir::Downsampler2x2F64Neon
		typedef Downsampler2x2F64Neon <NBR_COEFS> TestedType;
		AlignedObject <TestedType> container;
		TestedType &   dspl = container.use ();
		ret_val = TestDownsampler2x <TestedType>::perform_test (
			dspl, coef_arr, ss, "neon", transition_bw, stopband_at
	...
	if (ret_val == 0 && cpu._neon_flag)
	{
		// hiir::Upsampler2x2F64Neon
		typedef Upsampler2x2F64Neon <NBR_COEFS> TestedType;
		AlignedObject <TestedType> container;
		TestedType &   dspl = container.use ();
		ret_val = TestUpsampler2x <TestedType>::perform_test (
			dspl, coef_arr, ss, "neon", transition_bw, stopband_at
	...
	if (ret_val == 0 && cpu._neon_flag)
	{
		// hiir::Upsampler2xF64Neon
		typedef Upsampler2xF64Neon <NBR_COEFS> TestedType;
		AlignedObject <TestedType> container;
		TestedType &   dspl = container.use ();
		ret_val = TestUpsampler2x <TestedType>::perform_test (
			dspl, coef_arr, ss, "neon", transition_bw, stopband_at
	...
	if (ret_val == 0 && cpu._neon_flag)
	{
		// hiir::PhaseHalfPi2F64Neon
		typedef PhaseHalfPi2F64Neon <NBR_COEFS> TestedType;
		AlignedObject <TestedType> container;
		TestedType &   dspl = container.use ();
		ret_val = TestPhaseHalfPi <TestedType>::perform_test (
			dspl, coef_arr, ss, "neon", transition_bw
	...
	if (ret_val == 0 && cpu._neon_flag)
	{
		// hiir::PhaseHalfPiF64Neon
		typedef PhaseHalfPiF64Neon <NBR_COEFS> TestedType;
		AlignedObject <TestedType> container;
		TestedType &   dspl = container.use ();
		ret_val = TestPhaseHalfPi <TestedType>::perform_test (
			dspl, coef_arr, ss, "neon", transition_bw
