...
#pragma once
#if ! defined (hiir_HalfBandF64Neon_HEADER_INCLUDED)
#define hiir_HalfBandF64Neon_HEADER_INCLUDED
...
public:
	...
	static constexpr double _delay = 0;
	               ...
	               HalfBandF64Neon () noexcept;
	               HalfBandF64Neon (const HalfBandF64Neon <NC> &other)   = default;
	               HalfBandF64Neon (HalfBandF64Neon <NC> &&other)        = default;
	               ~HalfBandF64Neon ()                            = default;

	HalfBandF64Neon <NC> &
	               operator = (const HalfBandF64Neon <NC> &other) = default;
	HalfBandF64Neon <NC> &
	               operator = (HalfBandF64Neon <NC> &&other)      = default;
...
private:
	...
	bool           operator == (const HalfBandF64Neon <NC> &other) const = delete;
	bool           operator != (const HalfBandF64Neon <NC> &other) const = delete;
...
#include "hiir/HalfBandF64Neon.hpp"



#endif // hiir_HalfBandF64Neon_HEADER_INCLUDED
